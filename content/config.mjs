...
const config = {
    ...
    navLinks: [{ href: "/people/laloroe", name: "Perfil" },{ href: "/notas", name: "Mis Notas" },{ href: "/DS_IA", name: "Data Science e Inteligencia Artificial" },{ href: "/mas", name: "Más" },{ href: "/blog", name: "Blog" }],
    navBarTitle: {

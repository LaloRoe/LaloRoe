...
const config = {
    ...
    navLinks: [{ href: "/people/laloroe", name: "Perfil" },{ href: "/DS_IA", name: "Data Science e Inteligencia Artificial" },{ href: "/matematicas", name: "Matemáticas" },{ href: "/notas", name: "Mis Notas" },{ href: "/mas", name: "Más" },{ href: "/blog", name: "Blog" }],
    navBarTitle: {

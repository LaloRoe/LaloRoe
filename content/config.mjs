...
const config = {
    ...
    navLinks: [{ href: "/laloroe", name: "Perfil" },{ href: "/notas", name: "Mis Notas" },{ href: "/DS_IA", name: "Data Science e Inteligencia Artificial" },{ href: "/mas", name: "Más" },{ href: "/blog", name: "Blog" }],
    navBarTitle: {
